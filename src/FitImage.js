...
var height= (this.props.hackWidth == null) ? this.state.layoutWidth/originalWidth : this.props.hackWidth * originalHeight / originalWidth;
...
this.style,
this.getStyle(),
{height:this.state.height, width:this.props.hackWidth || this.state.layoutWidth},
